...
class PermitManagementListViewerPage extends StatefulWidget {
  bool? isAlert = false;
  PermitManagementListViewerPage({ this.isAlert });
  @override
  State<PermitManagementListViewerPage> createState() => _PermitManagementListViewerPageState();
}
class _PermitManagementListViewerPageState extends State<PermitManagementListViewerPage> {
  ...
  PermitManagement? replaceP;
  PermitManagement? createP;
    ...
    menuW['main'] = Column(
      children: [
        ...
        TextButton(
          onPressed: () async {
            createP = PermitManagement.fromDatabase({});
            await WidgetHub.pmCreateExcelEditeWidgetDl(context, createP!, saveFun: saveNewDate!);
          },
          style: StyleT.buttonStyleNone(padding: 0),
  ...
  void refresh() {
    ...
    for(var p in list) {
      ...
      w = WidgetHub.pmRowExcelWidget(context, p,
          fun: () async {
            WidgetHub.clear();
          ...
          color: backColor,);
      if(selectP == p) {
        w = WidgetHub.pmRowExcelEditeWidget(context, replaceP!, saveFun: saveEditDate,
            fun: () async {sideView('info', p: p);},
            color: backColor, setFun: () { refresh(); setState(() {}); });
      }
        ...
        child: AdaptiveScrollbar(
            ...
            child: AdaptiveScrollbar(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Container(
                      width: isViewShort ? 1300 : WidgetHub.allSize,
                      color: Colors.transparent,
                      child: ListView.builder(
                          controller: verticalScroll,
                          padding: EdgeInsets.only(left: 12, top: 12, bottom: 18),
